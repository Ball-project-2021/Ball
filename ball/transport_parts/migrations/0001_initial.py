    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exchange', models.BooleanField(blank=True, default=False, null=True, verbose_name='Փոխանակում')),
                ...
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='transport_parts.countrymodel')),
