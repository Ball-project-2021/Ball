...
SECRET_KEY = '-r6*fh(18xwz+60-mus9ydur1ix#qho+_i&h@1pc9+nfahc&-i'
...
INSTALLED_APPS = [
    ...
    # APPS===========
    'transports',  # autoner@
    'transport_accid',  # vtarvac /noroqman entaka
...
# JAMANAKAVORA //frontin miacman port
...
FILE_UPLOAD_PERMISSIONS = 0o6400
